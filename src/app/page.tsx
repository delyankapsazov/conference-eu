...
const features = [
  {
    bg: "bg-red",
    title: "Smooth running of your event",
    icon: (
  ...
  {
    bg: "bg-red-mid",
    title: "Professional equipment for every need",
    icon: (
      <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    bg: "bg-red-light",
    title: "Professional team with years of experience",
    icon: (
      <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-28 sm:py-36 lg:py-44">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-[43px] font-bold text-white tracking-tight">
              Technical Support for Conference and Congress Events
            </h1>
            <div className="mt-8">
              <a
                href="#services"
            ...
            <p className="mt-8 text-base sm:text-lg text-gray-300 max-w-2xl mx-auto">
              Everything you need for the smooth running of your event
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-[38px] font-bold text-dark uppercase inline-block pb-3 border-b-[3px] border-black mb-8">
              About Konferencia.BG
            </h2>
            <p className="text-gray-700 text-lg leading-relaxed">
              Professional technical support is an integral and very important part of every
              event. At Konferencia.bg we provide everything needed for the smooth running
              of your conferences, congresses, working meetings, symposiums and more.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-16 sm:py-24 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white leading-tight uppercase">
            NEED PROFESSIONAL TECHNICAL SUPPORT FOR YOUR EVENT?
          </h2>
          <a
            href="tel:0886401306"
